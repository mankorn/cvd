jQuery("#simulation")
  ...
  .on("focusin", ".s-15ab8f00-5bfb-4e43-a57e-01151e4977fb .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-15ab8f00-5bfb-4e43-a57e-01151e4977fb .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
